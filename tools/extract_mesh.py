...
if __name__ == "__main__":
    ...
    mesh = extract_mesh(
        ...
        chunk_rgb=args.chunk_rgb, sparse_data=sparse_data, renderer = neuconw_sys.renderer, neuconw=neuconw_sys.neuconw, NELO_para=NELO_para, device=args.local_rank, ckpt_path=args.ckpt_path)
    """
    ###raw extract_mesh
    mesh = extract_mesh(
        args.mesh_size, args.chunk, scene_config['radius'], scene_config['origin'],
